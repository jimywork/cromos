...
if (!Range.prototype['intersectsNode']) {
    Range.prototype['intersectsNode'] = function (node) {
        ...
        return this.compareBoundaryPoints(Range.END_TO_START, range) < 0 &&
            this.compareBoundaryPoints(Range.START_TO_END, range) > 0;
    };
}
...
class EdgeExtensionBridge {
    getBackgroundPage () {
        return bridgeLog.DoActionAndLog(() => myBrowser.extension.getBackgroundPage(), 'extension.getBackgroundPage');
    }
    getURL (path) {
        return bridgeLog.DoActionAndLog(() => myBrowser.extension.getURL(path), 'extension.getURL');
    }
    getViews (fetchProperties) {
        return bridgeLog.DoActionAndLog(() => myBrowser.extension.getViews(fetchProperties), 'extension.getViews');
    }
}
class EdgeChromeExtensionBridge extends EdgeExtensionBridge {
    get onConnect () { return bridgeLog.DoActionAndLog(() => EdgeRuntimeBridge.prototype.onConnect, 'extension.onConnect', 'runtime.onConnect', 'runtime.onConnect'); }
    get onMessage () { return bridgeLog.DoActionAndLog(() => myBrowser.runtime.onMessage, 'extension.onMessage', 'runtime.onMessage', 'runtime.onMessage'); }
    get onRequest () { return bridgeLog.DoActionAndLog(() => myBrowser.runtime.onMessage, 'extension.onRequest', 'runtime.onMessage', 'runtime.onMessage'); }
    get onRequestExternal () { return bridgeLog.DoActionAndLog(() => myBrowser.runtime.onMessageExternal, 'extension.onRequestExternal', 'runtime.onMessageExternal', 'runtime.onMessageExternal'); }
    get inIncognitoContext () { return bridgeLog.DoActionAndLog(() => myBrowser.extension["inPrivateContext"], 'extension.inIncognitoContext', undefined, 'extension.inPrivateContext'); }
    get lastError () { return bridgeLog.DoActionAndLog(() => myBrowser.runtime.lastError, 'extension.lastError', undefined, 'runtime.lastError'); }
    connect (extensionId, connectInfo) {
        return bridgeLog.DoActionAndLog(() => EdgeRuntimeBridge.prototype.connect(extensionId, connectInfo), 'extension.connect', 'runtime.connect', 'runtime.connect');
    }
    sendMessage (message, responseCallback) {
        return bridgeLog.DoActionAndLog(() => EdgeRuntimeBridge.prototype.sendMessage(message, responseCallback, undefined, undefined), 'extension.sendMessage', 'runtime.sendMessage', 'runtime.sendMessage');
    }
    sendRequest (extensionId, message, options, responseCallback) {
        return bridgeLog.DoActionAndLog(() => EdgeRuntimeBridge.prototype.sendMessage(extensionId, message, options, responseCallback), 'extension.sendRequest', 'runtime.sendMessage', 'runtime.sendMessage');
    }
...
class EdgeI18nBridge {
    getAcceptLanguages (callback) {
        return bridgeLog.DoActionAndLog(() => myBrowser.i18n.getAcceptLanguages(callback), 'i18n.getAcceptLanguages');
    }
    ...
    getUILanguage () {
        return bridgeLog.DoActionAndLog(() => myBrowser.i18n.getUILanguage(), 'i18n.getUILanguage');
    }
}
class EdgeRuntimeBridge {
    get id () { return bridgeLog.DoActionAndLog(() => myBrowser.runtime.id, 'runtime.id'); }
    get lastError () { return bridgeLog.DoActionAndLog(() => myBrowser.runtime.lastError, 'runtime.lastError'); }
    get onConnect () { return bridgeLog.DoActionAndLog(() => myBrowser.runtime.onConnect, 'runtime.onConnect'); }
    get onInstalled () { return bridgeLog.DoActionAndLog(() => myBrowser.runtime.onInstalled, 'runtime.onInstalled'); }
    get onMessage () { return bridgeLog.DoActionAndLog(() => myBrowser.runtime.onMessage, 'runtime.onMessage'); }
    get onMessageExternal () { return bridgeLog.DoActionAndLog(() => myBrowser.runtime.onMessageExternal, 'runtime.onMessageExternal'); }
    connect (extensionId, connectInfo) {
        return bridgeLog.DoActionAndLog(() => {
    ...
    getManifest () {
        return bridgeLog.DoActionAndLog(() => myBrowser.runtime.getManifest(), 'runtime.getManifest');
    }
    getURL (path) {
        return bridgeLog.DoActionAndLog(() => myBrowser.runtime.getURL(path), 'runtime.getURL');
    }
...
class EdgeStorageBridge {
    get local () { return bridgeLog.DoActionAndLog(() => myBrowser.storage.local, 'storage.local'); }
    get onChanged () { return bridgeLog.DoActionAndLog(() => myBrowser.storage.onChanged, 'storage.onChanged'); }
}
class EdgeChromeStorageBridge extends EdgeStorageBridge {
    get managed () { return bridgeLog.DoActionAndLog(() => myBrowser.storage.local, 'storage.managed', undefined, 'storage.local'); }
    get sync () { return bridgeLog.DoActionAndLog(() => myBrowser.storage.local, 'storage.sync', undefined, 'storage.local'); }
}
